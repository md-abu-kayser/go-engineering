...
- Explain the engineering purpose of **Rpc Client** in the context of networking distributed.
...
**Rpc Client** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-15-networking-distributed/21-rpc-client
go run .
`
