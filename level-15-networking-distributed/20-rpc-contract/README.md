...
- Explain the engineering purpose of **Rpc Contract** in the context of networking distributed.
...
**Rpc Contract** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-15-networking-distributed/20-rpc-contract
go run .
`
