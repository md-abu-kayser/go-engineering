# 38 — Event Driven Service

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Event Driven Service** in the context of networking distributed.
...
**Event Driven Service** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-15-networking-distributed/38-event-driven-service
go run .
`
