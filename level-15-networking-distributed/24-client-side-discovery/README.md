# 24 — Client Side Discovery

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Client Side Discovery** in the context of networking distributed.
...
**Client Side Discovery** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-15-networking-distributed/24-client-side-discovery
go run .
`
