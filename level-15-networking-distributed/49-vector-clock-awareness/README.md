# 49 — Vector Clock Awareness

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Vector Clock Awareness** in the context of networking distributed.
...
**Vector Clock Awareness** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-15-networking-distributed/49-vector-clock-awareness
go run .
`
