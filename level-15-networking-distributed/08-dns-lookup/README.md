...
- Explain the engineering purpose of **Dns Lookup** in the context of networking distributed.
...
**Dns Lookup** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-15-networking-distributed/08-dns-lookup
go run .
`
