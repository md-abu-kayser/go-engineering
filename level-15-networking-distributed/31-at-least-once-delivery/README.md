# 31 — At Least Once Delivery

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **At Least Once Delivery** in the context of networking distributed.
...
**At Least Once Delivery** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-15-networking-distributed/31-at-least-once-delivery
go run .
`
