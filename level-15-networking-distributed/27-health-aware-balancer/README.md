# 27 — Health Aware Balancer

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Health Aware Balancer** in the context of networking distributed.
...
**Health Aware Balancer** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-15-networking-distributed/27-health-aware-balancer
go run .
`
