# 45 — Backpressure Network

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Backpressure Network** in the context of networking distributed.
...
**Backpressure Network** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-15-networking-distributed/45-backpressure-network
go run .
`
