# 26 — Round Robin Balancer

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Round Robin Balancer** in the context of networking distributed.
...
**Round Robin Balancer** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-15-networking-distributed/26-round-robin-balancer
go run .
`
