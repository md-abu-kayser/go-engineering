# 14 — Websocket Heartbeat

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Websocket Heartbeat** in the context of networking distributed.
...
**Websocket Heartbeat** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-15-networking-distributed/14-websocket-heartbeat
go run .
`
