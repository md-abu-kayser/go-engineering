# 29 — Message Queue Consumer

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Message Queue Consumer** in the context of networking distributed.
...
**Message Queue Consumer** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-15-networking-distributed/29-message-queue-consumer
go run .
`
