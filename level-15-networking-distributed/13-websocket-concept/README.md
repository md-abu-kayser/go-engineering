# 13 — Websocket Concept

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Websocket Concept** in the context of networking distributed.
...
**Websocket Concept** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-15-networking-distributed/13-websocket-concept
go run .
`
