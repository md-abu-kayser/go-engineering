# 33 — Exactly Once Myth

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Exactly Once Myth** in the context of networking distributed.
...
**Exactly Once Myth** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-15-networking-distributed/33-exactly-once-myth
go run .
`
