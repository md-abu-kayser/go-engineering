...
- Explain the engineering purpose of **Http2 Awareness** in the context of networking distributed.
...
**Http2 Awareness** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-15-networking-distributed/11-http2-awareness
go run .
`
