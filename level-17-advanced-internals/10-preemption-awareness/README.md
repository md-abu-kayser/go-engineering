# 10 — Preemption Awareness

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Preemption Awareness** in the context of advanced internals.
...
**Preemption Awareness** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-17-advanced-internals/10-preemption-awareness
go run .
`
