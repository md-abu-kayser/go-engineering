# 2 — Happens Before Channels

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Happens Before Channels** in the context of advanced internals.
...
**Happens Before Channels** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-17-advanced-internals/02-happens-before-channels
go run .
`
