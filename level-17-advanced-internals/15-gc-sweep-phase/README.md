...
- Explain the engineering purpose of **Gc Sweep Phase** in the context of advanced internals.
...
**Gc Sweep Phase** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-17-advanced-internals/15-gc-sweep-phase
go run .
`
