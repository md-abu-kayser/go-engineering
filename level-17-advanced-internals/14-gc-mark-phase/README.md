...
- Explain the engineering purpose of **Gc Mark Phase** in the context of advanced internals.
...
**Gc Mark Phase** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-17-advanced-internals/14-gc-mark-phase
go run .
`
