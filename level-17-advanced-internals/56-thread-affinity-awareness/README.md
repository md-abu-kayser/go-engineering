# 56 — Thread Affinity Awareness

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Thread Affinity Awareness** in the context of advanced internals.
...
**Thread Affinity Awareness** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-17-advanced-internals/56-thread-affinity-awareness
go run .
`
