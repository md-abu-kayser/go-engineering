# 29 — Type Descriptor Awareness

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Type Descriptor Awareness** in the context of advanced internals.
...
**Type Descriptor Awareness** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-17-advanced-internals/29-type-descriptor-awareness
go run .
`
