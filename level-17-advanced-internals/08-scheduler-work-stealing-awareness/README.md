# 8 — Scheduler Work Stealing Awareness

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Scheduler Work Stealing Awareness** in the context of advanced internals.
...
**Scheduler Work Stealing Awareness** is most useful when it makes a program's behavior clearer, safer, or easier to change.
This lesson deliberately keeps the example local and observable: it demonstrates safe runtime observation through supported `runtime` APIs. The
...
`ash
cd level-17-advanced-internals/08-scheduler-work-stealing-awareness
go run .
`
