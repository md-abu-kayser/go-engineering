...
- Explain the engineering purpose of **Symbol Resolution** in the context of advanced internals.
...
**Symbol Resolution** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-17-advanced-internals/35-symbol-resolution
go run .
`
