...
- Explain the engineering purpose of **Data Race Example** in the context of advanced internals.
...
**Data Race Example** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-17-advanced-internals/05-data-race-example
go run .
`
