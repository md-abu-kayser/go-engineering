# 28 — Reflection Internals

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Reflection Internals** in the context of advanced internals.
...
**Reflection Internals** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-17-advanced-internals/28-reflection-internals
go run .
`
