# 12 — Stack Copying Awareness

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Stack Copying Awareness** in the context of advanced internals.
...
**Stack Copying Awareness** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-17-advanced-internals/12-stack-copying-awareness
go run .
`
