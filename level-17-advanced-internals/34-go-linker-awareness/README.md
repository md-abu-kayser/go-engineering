# 34 — Go Linker Awareness

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Go Linker Awareness** in the context of advanced internals.
...
**Go Linker Awareness** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-17-advanced-internals/34-go-linker-awareness
go run .
`
