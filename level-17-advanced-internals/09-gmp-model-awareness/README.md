# 9 — Gmp Model Awareness

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Gmp Model Awareness** in the context of advanced internals.
...
**Gmp Model Awareness** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-17-advanced-internals/09-gmp-model-awareness
go run .
`
