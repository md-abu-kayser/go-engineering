# 30 — Unsafe Pointer Rules

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Unsafe Pointer Rules** in the context of advanced internals.
...
**Unsafe Pointer Rules** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-17-advanced-internals/30-unsafe-pointer-rules
go run .
`
