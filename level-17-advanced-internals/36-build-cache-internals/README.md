# 36 — Build Cache Internals

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Build Cache Internals** in the context of advanced internals.
...
**Build Cache Internals** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-17-advanced-internals/36-build-cache-internals
go run .
`
