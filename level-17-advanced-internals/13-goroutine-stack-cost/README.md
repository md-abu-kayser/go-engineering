# 13 — Goroutine Stack Cost

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Goroutine Stack Cost** in the context of advanced internals.
...
**Goroutine Stack Cost** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-17-advanced-internals/13-goroutine-stack-cost
go run .
`
