# 18 — Escape Analysis Example

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Escape Analysis Example** in the context of advanced internals.
...
**Escape Analysis Example** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-17-advanced-internals/18-escape-analysis-example
go run .
`
