...
- Explain the engineering purpose of **Stack Growth** in the context of advanced internals.
...
**Stack Growth** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-17-advanced-internals/11-stack-growth
go run .
`
