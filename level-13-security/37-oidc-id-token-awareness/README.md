# 37 — Oidc Id Token Awareness

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Oidc Id Token Awareness** in the context of security.
...
**Oidc Id Token Awareness** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-13-security/37-oidc-id-token-awareness
go run .
`
