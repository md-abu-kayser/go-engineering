...
- Explain the engineering purpose of **Input Validation** in the context of security.
...
**Input Validation** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-13-security/20-input-validation
go run .
`
