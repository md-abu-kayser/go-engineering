...
- Explain the engineering purpose of **Same Site Cookies** in the context of security.
...
**Same Site Cookies** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-13-security/11-same-site-cookies
go run .
`
