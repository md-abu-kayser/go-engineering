# 6 — Crypto Rand Tokens

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Crypto Rand Tokens** in the context of security.
...
**Crypto Rand Tokens** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-13-security/06-crypto-rand-tokens
go run .
`
