# 28 — Open Redirect Defense

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Open Redirect Defense** in the context of security.
...
**Open Redirect Defense** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-13-security/28-open-redirect-defense
go run .
`
