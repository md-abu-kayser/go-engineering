...
- Explain the engineering purpose of **Path Traversal Defense** in the context of security.
...
**Path Traversal Defense** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-13-security/22-path-traversal-defense
go run .
`
