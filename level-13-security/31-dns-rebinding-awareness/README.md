# 31 — Dns Rebinding Awareness

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Dns Rebinding Awareness** in the context of security.
...
**Dns Rebinding Awareness** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-13-security/31-dns-rebinding-awareness
go run .
`
