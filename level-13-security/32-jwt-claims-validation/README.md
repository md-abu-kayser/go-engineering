# 32 — Jwt Claims Validation

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Jwt Claims Validation** in the context of security.
...
**Jwt Claims Validation** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-13-security/32-jwt-claims-validation
go run .
`
