...
- Explain the engineering purpose of **Resource Authorization** in the context of security.
...
**Resource Authorization** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-13-security/40-resource-authorization
go run .
`
