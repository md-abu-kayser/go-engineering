# 21 — Allowlist Validation

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Allowlist Validation** in the context of security.
...
**Allowlist Validation** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-13-security/21-allowlist-validation
go run .
`
