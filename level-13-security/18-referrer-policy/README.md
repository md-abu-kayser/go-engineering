...
- Explain the engineering purpose of **Referrer Policy** in the context of security.
...
**Referrer Policy** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-13-security/18-referrer-policy
go run .
`
