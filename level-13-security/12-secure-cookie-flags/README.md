# 12 — Secure Cookie Flags

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Secure Cookie Flags** in the context of security.
...
**Secure Cookie Flags** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-13-security/12-secure-cookie-flags
go run .
`
