# 18 — Reflection Interface

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Reflection Interface** in the context of intermediate go.
...
**Reflection Interface** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-03-intermediate-go/18-reflection-interface
go run .
`
