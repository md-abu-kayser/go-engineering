...
- Explain the engineering purpose of **Example Tests** in the context of intermediate go.
...
**Example Tests** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-03-intermediate-go/56-example-tests
go run .
`
