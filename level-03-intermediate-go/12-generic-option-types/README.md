# 12 — Generic Option Types

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Generic Option Types** in the context of intermediate go.
...
**Generic Option Types** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-03-intermediate-go/12-generic-option-types
go run .
`
