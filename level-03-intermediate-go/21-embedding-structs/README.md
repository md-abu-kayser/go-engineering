# 21 — Embedding Structs

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Embedding Structs** in the context of intermediate go.
...
**Embedding Structs** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-03-intermediate-go/21-embedding-structs
go run .
`
