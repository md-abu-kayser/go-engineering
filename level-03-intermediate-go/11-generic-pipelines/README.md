# 11 — Generic Pipelines

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Generic Pipelines** in the context of intermediate go.
...
**Generic Pipelines** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-03-intermediate-go/11-generic-pipelines
go run .
`
