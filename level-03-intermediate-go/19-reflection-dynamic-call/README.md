# 19 — Reflection Dynamic Call

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Reflection Dynamic Call** in the context of intermediate go.
...
**Reflection Dynamic Call** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-03-intermediate-go/19-reflection-dynamic-call
go run .
`
