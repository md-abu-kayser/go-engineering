...
- Explain the engineering purpose of **Vendoring** in the context of intermediate go.
...
**Vendoring** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-03-intermediate-go/36-vendoring
go run .
`
