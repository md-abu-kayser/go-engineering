# 42 — Public Api Boundaries

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Public Api Boundaries** in the context of intermediate go.
...
**Public Api Boundaries** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-03-intermediate-go/42-public-api-boundaries
go run .
`
