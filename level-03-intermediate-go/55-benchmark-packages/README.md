# 55 — Benchmark Packages

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Benchmark Packages** in the context of intermediate go.
...
**Benchmark Packages** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-03-intermediate-go/55-benchmark-packages
go run .
`
