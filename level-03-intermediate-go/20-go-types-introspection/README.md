# 20 — Go Types Introspection

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Go Types Introspection** in the context of intermediate go.
...
**Go Types Introspection** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-03-intermediate-go/20-go-types-introspection
go run .
`
