# 27 — Import Dot Discouraged

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Import Dot Discouraged** in the context of intermediate go.
...
**Import Dot Discouraged** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-03-intermediate-go/27-import-dot-discouraged
go run .
`
