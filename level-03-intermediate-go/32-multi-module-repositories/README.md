# 32 — Multi Module Repositories

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Multi Module Repositories** in the context of intermediate go.
...
**Multi Module Repositories** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-03-intermediate-go/32-multi-module-repositories
go run .
`
