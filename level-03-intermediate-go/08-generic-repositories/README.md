# 8 — Generic Repositories

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Generic Repositories** in the context of intermediate go.
...
**Generic Repositories** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-03-intermediate-go/08-generic-repositories
go run .
`
