# 13 — Reflection Values

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Reflection Values** in the context of intermediate go.
...
**Reflection Values** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-03-intermediate-go/13-reflection-values
go run .
`
