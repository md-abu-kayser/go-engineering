# 17 — Reflection Addressability

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Reflection Addressability** in the context of intermediate go.
...
**Reflection Addressability** is most useful when it makes a program's behavior clearer, safer, or easier to change.
This lesson deliberately keeps the example local and observable: it demonstrates the relationship between a value, its `reflect.Type`, its `reflect.Value`, and a struct tag. The
...
`ash
cd level-03-intermediate-go/17-reflection-addressability
go run .
`
