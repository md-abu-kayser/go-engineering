# 17 — Strconv Parse Float

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Strconv Parse Float** in the context of standard library.
...
**Strconv Parse Float** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-05-standard-library/17-strconv-parse-float
go run .
`
