...
- Explain the engineering purpose of **Os Create** in the context of standard library.
...
**Os Create** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-05-standard-library/34-os-create
go run .
`
