...
- Explain the engineering purpose of **Cmp Package** in the context of standard library.
...
**Cmp Package** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-05-standard-library/25-cmp-package
go run .
`
