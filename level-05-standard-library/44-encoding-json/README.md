...
- Explain the engineering purpose of **Encoding Json** in the context of standard library.
...
**Encoding Json** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-05-standard-library/44-encoding-json
go run .
`
