...
- Explain the engineering purpose of **Sort Search** in the context of standard library.
...
**Sort Search** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-05-standard-library/22-sort-search
go run .
`
