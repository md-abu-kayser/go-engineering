# 37 — Os File Permissions

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Os File Permissions** in the context of standard library.
...
**Os File Permissions** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-05-standard-library/37-os-file-permissions
go run .
`
