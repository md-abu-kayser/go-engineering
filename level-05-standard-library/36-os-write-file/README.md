...
- Explain the engineering purpose of **Os Write File** in the context of standard library.
...
**Os Write File** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-05-standard-library/36-os-write-file
go run .
`
