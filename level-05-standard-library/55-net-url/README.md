...
- Explain the engineering purpose of **Net Url** in the context of standard library.
...
**Net Url** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-05-standard-library/55-net-url
go run .
`
