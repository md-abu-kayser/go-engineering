...
- Explain the engineering purpose of **Strings Split** in the context of standard library.
...
**Strings Split** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-05-standard-library/05-strings-split
go run .
`
