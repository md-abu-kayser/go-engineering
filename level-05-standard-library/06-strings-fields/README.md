...
- Explain the engineering purpose of **Strings Fields** in the context of standard library.
...
**Strings Fields** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-05-standard-library/06-strings-fields
go run .
`
