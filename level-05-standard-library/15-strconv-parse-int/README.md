# 15 — Strconv Parse Int

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Strconv Parse Int** in the context of standard library.
...
**Strconv Parse Int** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-05-standard-library/15-strconv-parse-int
go run .
`
