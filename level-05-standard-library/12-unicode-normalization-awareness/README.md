# 12 — Unicode Normalization Awareness

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Unicode Normalization Awareness** in the context of standard library.
...
**Unicode Normalization Awareness** is most useful when it makes a program's behavior clearer, safer, or easier to change.
This lesson deliberately keeps the example local and observable: it demonstrates standard-library string processing and JSON encoding. The
...
`ash
cd level-05-standard-library/12-unicode-normalization-awareness
go run .
`
