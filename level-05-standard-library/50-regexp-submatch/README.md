...
- Explain the engineering purpose of **Regexp Submatch** in the context of standard library.
...
**Regexp Submatch** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-05-standard-library/50-regexp-submatch
go run .
`
