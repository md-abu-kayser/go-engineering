...
- Explain the engineering purpose of **Mime Types** in the context of standard library.
...
**Mime Types** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-05-standard-library/56-mime-types
go run .
`
