...
- Explain the engineering purpose of **Encoding Xml** in the context of standard library.
...
**Encoding Xml** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-05-standard-library/45-encoding-xml
go run .
`
