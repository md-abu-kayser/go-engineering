...
- Explain the engineering purpose of **Os Getwd** in the context of standard library.
...
**Os Getwd** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-05-standard-library/33-os-getwd
go run .
`
