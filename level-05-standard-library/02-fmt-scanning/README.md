...
- Explain the engineering purpose of **Fmt Scanning** in the context of standard library.
...
**Fmt Scanning** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-05-standard-library/02-fmt-scanning
go run .
`
