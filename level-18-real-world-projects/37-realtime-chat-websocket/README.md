# 37 — Realtime Chat Websocket

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Realtime Chat Websocket** in the context of real world projects.
...
**Realtime Chat Websocket** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-18-real-world-projects/37-realtime-chat-websocket
go run .
`
