...
- Explain the engineering purpose of **Cli Notes** in the context of real world projects.
...
**Cli Notes** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-18-real-world-projects/01-cli-notes
go run .
`
