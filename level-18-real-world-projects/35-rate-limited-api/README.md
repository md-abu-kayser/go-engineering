...
- Explain the engineering purpose of **Rate Limited Api** in the context of real world projects.
...
**Rate Limited Api** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-18-real-world-projects/35-rate-limited-api
go run .
`
