# 24 — Email Queue Worker

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Email Queue Worker** in the context of real world projects.
...
**Email Queue Worker** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-18-real-world-projects/24-email-queue-worker
go run .
`
