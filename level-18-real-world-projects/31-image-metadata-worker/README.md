# 31 — Image Metadata Worker

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Image Metadata Worker** in the context of real world projects.
...
**Image Metadata Worker** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-18-real-world-projects/31-image-metadata-worker
go run .
`
