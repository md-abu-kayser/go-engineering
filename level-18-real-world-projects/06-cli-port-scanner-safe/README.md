# 6 — Cli Port Scanner Safe

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Cli Port Scanner Safe** in the context of real world projects.
...
**Cli Port Scanner Safe** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-18-real-world-projects/06-cli-port-scanner-safe
go run .
`
