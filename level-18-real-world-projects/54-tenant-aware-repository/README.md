# 54 — Tenant Aware Repository

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Tenant Aware Repository** in the context of real world projects.
...
**Tenant Aware Repository** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-18-real-world-projects/54-tenant-aware-repository
go run .
`
