# 20 — Payment Intent Simulator

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Payment Intent Simulator** in the context of real world projects.
...
**Payment Intent Simulator** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-18-real-world-projects/20-payment-intent-simulator
go run .
`
