# 50 — Health Aggregator

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Health Aggregator** in the context of real world projects.
...
**Health Aggregator** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-18-real-world-projects/50-health-aggregator
go run .
`
