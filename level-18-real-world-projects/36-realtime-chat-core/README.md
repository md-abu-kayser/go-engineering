# 36 — Realtime Chat Core

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Realtime Chat Core** in the context of real world projects.
...
**Realtime Chat Core** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-18-real-world-projects/36-realtime-chat-core
go run .
`
