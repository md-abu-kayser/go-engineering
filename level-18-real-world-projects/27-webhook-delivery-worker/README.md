# 27 — Webhook Delivery Worker

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Webhook Delivery Worker** in the context of real world projects.
...
**Webhook Delivery Worker** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-18-real-world-projects/27-webhook-delivery-worker
go run .
`
