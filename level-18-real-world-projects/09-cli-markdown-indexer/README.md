# 9 — Cli Markdown Indexer

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Cli Markdown Indexer** in the context of real world projects.
...
**Cli Markdown Indexer** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-18-real-world-projects/09-cli-markdown-indexer
go run .
`
