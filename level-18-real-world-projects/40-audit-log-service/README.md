# 40 — Audit Log Service

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Audit Log Service** in the context of real world projects.
...
**Audit Log Service** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-18-real-world-projects/40-audit-log-service
go run .
`
