# 33 — Report Generation Service

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Report Generation Service** in the context of real world projects.
...
**Report Generation Service** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-18-real-world-projects/33-report-generation-service
go run .
`
