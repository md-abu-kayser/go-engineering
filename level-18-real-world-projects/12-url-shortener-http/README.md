# 12 — Url Shortener Http

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Url Shortener Http** in the context of real world projects.
...
**Url Shortener Http** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-18-real-world-projects/12-url-shortener-http
go run .
`
