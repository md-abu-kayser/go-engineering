# 11 — Url Shortener Core

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Url Shortener Core** in the context of real world projects.
...
**Url Shortener Core** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-18-real-world-projects/11-url-shortener-core
go run .
`
