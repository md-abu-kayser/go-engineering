...
- Explain the engineering purpose of **Presence Service** in the context of real world projects.
...
**Presence Service** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-18-real-world-projects/38-presence-service
go run .
`
