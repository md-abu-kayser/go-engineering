# 32 — Slog Json Handler

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Slog Json Handler** in the context of cli systems.
...
**Slog Json Handler** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/32-slog-json-handler
go run .
`
