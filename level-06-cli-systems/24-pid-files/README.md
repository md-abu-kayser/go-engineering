...
- Explain the engineering purpose of **Pid Files** in the context of cli systems.
...
**Pid Files** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/24-pid-files
go run .
`
