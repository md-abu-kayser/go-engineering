...
- Explain the engineering purpose of **Config Validation** in the context of cli systems.
...
**Config Validation** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/41-config-validation
go run .
`
