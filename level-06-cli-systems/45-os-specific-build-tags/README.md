# 45 — Os Specific Build Tags

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Os Specific Build Tags** in the context of cli systems.
...
**Os Specific Build Tags** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/45-os-specific-build-tags
go run .
`
