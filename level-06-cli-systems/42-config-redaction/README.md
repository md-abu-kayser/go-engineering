...
- Explain the engineering purpose of **Config Redaction** in the context of cli systems.
...
**Config Redaction** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/42-config-redaction
go run .
`
