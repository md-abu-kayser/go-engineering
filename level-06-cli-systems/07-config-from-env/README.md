...
- Explain the engineering purpose of **Config From Env** in the context of cli systems.
...
**Config From Env** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/07-config-from-env
go run .
`
