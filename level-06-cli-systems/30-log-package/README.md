...
- Explain the engineering purpose of **Log Package** in the context of cli systems.
...
**Log Package** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/30-log-package
go run .
`
