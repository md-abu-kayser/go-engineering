...
- Explain the engineering purpose of **Stdout Streaming** in the context of cli systems.
...
**Stdout Streaming** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/28-stdout-streaming
go run .
`
