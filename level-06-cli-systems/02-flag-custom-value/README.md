...
- Explain the engineering purpose of **Flag Custom Value** in the context of cli systems.
...
**Flag Custom Value** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/02-flag-custom-value
go run .
`
