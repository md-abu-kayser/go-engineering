# 51 — Child Process Signals

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Child Process Signals** in the context of cli systems.
...
**Child Process Signals** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/51-child-process-signals
go run .
`
