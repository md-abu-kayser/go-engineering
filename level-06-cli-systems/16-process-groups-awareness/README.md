# 16 — Process Groups Awareness

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Process Groups Awareness** in the context of cli systems.
...
**Process Groups Awareness** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/16-process-groups-awareness
go run .
`
