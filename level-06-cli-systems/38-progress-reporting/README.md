...
- Explain the engineering purpose of **Progress Reporting** in the context of cli systems.
...
**Progress Reporting** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/38-progress-reporting
go run .
`
