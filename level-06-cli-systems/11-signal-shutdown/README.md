...
- Explain the engineering purpose of **Signal Shutdown** in the context of cli systems.
...
**Signal Shutdown** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/11-signal-shutdown
go run .
`
