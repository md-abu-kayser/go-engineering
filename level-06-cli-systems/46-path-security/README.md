...
- Explain the engineering purpose of **Path Security** in the context of cli systems.
...
**Path Security** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/46-path-security
go run .
`
