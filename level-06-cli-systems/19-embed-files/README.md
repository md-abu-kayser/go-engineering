...
- Explain the engineering purpose of **Embed Files** in the context of cli systems.
...
**Embed Files** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/19-embed-files
go run .
`
