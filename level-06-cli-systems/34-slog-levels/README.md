...
- Explain the engineering purpose of **Slog Levels** in the context of cli systems.
...
**Slog Levels** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/34-slog-levels
go run .
`
