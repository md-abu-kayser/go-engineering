# 50 — Subprocess Supervision

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Subprocess Supervision** in the context of cli systems.
...
**Subprocess Supervision** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/50-subprocess-supervision
go run .
`
