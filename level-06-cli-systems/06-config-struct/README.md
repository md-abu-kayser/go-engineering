...
- Explain the engineering purpose of **Config Struct** in the context of cli systems.
...
**Config Struct** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/06-config-struct
go run .
`
