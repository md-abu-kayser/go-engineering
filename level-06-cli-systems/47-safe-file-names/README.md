...
- Explain the engineering purpose of **Safe File Names** in the context of cli systems.
...
**Safe File Names** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/47-safe-file-names
go run .
`
