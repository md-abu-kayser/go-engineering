...
- Explain the engineering purpose of **Subcommands** in the context of cli systems.
...
**Subcommands** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/03-subcommands
go run .
`
