...
- Explain the engineering purpose of **Exec Streaming** in the context of cli systems.
...
**Exec Streaming** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/14-exec-streaming
go run .
`
