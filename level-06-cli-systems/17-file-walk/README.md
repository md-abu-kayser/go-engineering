...
- Explain the engineering purpose of **File Walk** in the context of cli systems.
...
**File Walk** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/17-file-walk
go run .
`
