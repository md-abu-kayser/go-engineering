...
- Explain the engineering purpose of **Cli Testing** in the context of cli systems.
...
**Cli Testing** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/55-cli-testing
go run .
`
