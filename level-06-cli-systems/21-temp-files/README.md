...
- Explain the engineering purpose of **Temp Files** in the context of cli systems.
...
**Temp Files** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/21-temp-files
go run .
`
