# 35 — Structured Cli Errors

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Structured Cli Errors** in the context of cli systems.
...
**Structured Cli Errors** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/35-structured-cli-errors
go run .
`
