...
- Explain the engineering purpose of **Cli Exit Codes** in the context of cli systems.
...
**Cli Exit Codes** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/05-cli-exit-codes
go run .
`
