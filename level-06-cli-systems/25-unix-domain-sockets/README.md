# 25 — Unix Domain Sockets

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Unix Domain Sockets** in the context of cli systems.
...
**Unix Domain Sockets** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/25-unix-domain-sockets
go run .
`
