...
- Explain the engineering purpose of **Slog Context** in the context of cli systems.
...
**Slog Context** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/33-slog-context
go run .
`
