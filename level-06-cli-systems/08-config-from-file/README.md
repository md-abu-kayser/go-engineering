...
- Explain the engineering purpose of **Config From File** in the context of cli systems.
...
**Config From File** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/08-config-from-file
go run .
`
