...
- Explain the engineering purpose of **File Descriptors** in the context of cli systems.
...
**File Descriptors** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/26-file-descriptors
go run .
`
