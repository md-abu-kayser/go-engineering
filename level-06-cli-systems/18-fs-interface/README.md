...
- Explain the engineering purpose of **Fs Interface** in the context of cli systems.
...
**Fs Interface** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/18-fs-interface
go run .
`
