...
- Explain the engineering purpose of **Stderr Logging** in the context of cli systems.
...
**Stderr Logging** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/29-stderr-logging
go run .
`
