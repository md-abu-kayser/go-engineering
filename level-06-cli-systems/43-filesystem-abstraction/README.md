# 43 — Filesystem Abstraction

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Filesystem Abstraction** in the context of cli systems.
...
**Filesystem Abstraction** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/43-filesystem-abstraction
go run .
`
