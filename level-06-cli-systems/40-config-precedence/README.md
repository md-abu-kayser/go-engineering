# 40 — Config Precedence

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Config Precedence** in the context of cli systems.
...
**Config Precedence** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/40-config-precedence
go run .
`
