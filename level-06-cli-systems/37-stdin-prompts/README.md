...
- Explain the engineering purpose of **Stdin Prompts** in the context of cli systems.
...
**Stdin Prompts** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/37-stdin-prompts
go run .
`
