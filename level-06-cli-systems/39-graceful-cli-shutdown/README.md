# 39 — Graceful Cli Shutdown

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Graceful Cli Shutdown** in the context of cli systems.
...
**Graceful Cli Shutdown** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/39-graceful-cli-shutdown
go run .
`
