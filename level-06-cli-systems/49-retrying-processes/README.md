# 49 — Retrying Processes

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Retrying Processes** in the context of cli systems.
...
**Retrying Processes** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/49-retrying-processes
go run .
`
