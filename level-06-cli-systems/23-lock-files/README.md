...
- Explain the engineering purpose of **Lock Files** in the context of cli systems.
...
**Lock Files** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/23-lock-files
go run .
`
