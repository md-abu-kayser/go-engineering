# 9 — Dotenv Like Loader

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Dotenv Like Loader** in the context of cli systems.
...
**Dotenv Like Loader** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/09-dotenv-like-loader
go run .
`
