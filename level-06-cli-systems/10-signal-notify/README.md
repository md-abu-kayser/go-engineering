...
- Explain the engineering purpose of **Signal Notify** in the context of cli systems.
...
**Signal Notify** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/10-signal-notify
go run .
`
