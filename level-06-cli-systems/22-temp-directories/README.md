...
- Explain the engineering purpose of **Temp Directories** in the context of cli systems.
...
**Temp Directories** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/22-temp-directories
go run .
`
