# 36 — Terminal Detection

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Terminal Detection** in the context of cli systems.
...
**Terminal Detection** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/36-terminal-detection
go run .
`
