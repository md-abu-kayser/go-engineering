...
- Explain the engineering purpose of **Cli Help** in the context of cli systems.
...
**Cli Help** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-06-cli-systems/04-cli-help
go run .
`
