# 19 — Postgres Placeholders

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Postgres Placeholders** in the context of databases.
...
**Postgres Placeholders** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-08-databases/19-postgres-placeholders
go run .
`
