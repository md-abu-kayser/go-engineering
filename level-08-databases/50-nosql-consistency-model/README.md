# 50 — Nosql Consistency Model

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Nosql Consistency Model** in the context of databases.
...
**Nosql Consistency Model** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-08-databases/50-nosql-consistency-model
go run .
`
