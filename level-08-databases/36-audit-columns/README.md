...
- Explain the engineering purpose of **Audit Columns** in the context of databases.
...
**Audit Columns** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-08-databases/36-audit-columns
go run .
`
