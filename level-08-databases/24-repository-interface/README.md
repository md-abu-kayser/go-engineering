...
- Explain the engineering purpose of **Repository Interface** in the context of databases.
...
**Repository Interface** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-08-databases/24-repository-interface
go run .
`
