...
- Explain the engineering purpose of **Upsert Sql** in the context of databases.
...
**Upsert Sql** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-08-databases/32-upsert-sql
go run .
`
