...
- Explain the engineering purpose of **Exec Statement** in the context of databases.
...
**Exec Statement** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-08-databases/05-exec-statement
go run .
`
