# 39 — Idempotency Table

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Idempotency Table** in the context of databases.
...
**Idempotency Table** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-08-databases/39-idempotency-table
go run .
`
