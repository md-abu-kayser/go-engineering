# 49 — Nosql Key Value Model

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Nosql Key Value Model** in the context of databases.
...
**Nosql Key Value Model** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-08-databases/49-nosql-key-value-model
go run .
`
