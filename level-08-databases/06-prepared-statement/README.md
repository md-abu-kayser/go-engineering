...
- Explain the engineering purpose of **Prepared Statement** in the context of databases.
...
**Prepared Statement** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-08-databases/06-prepared-statement
go run .
`
