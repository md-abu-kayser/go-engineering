...
- Explain the engineering purpose of **Transactions** in the context of databases.
...
**Transactions** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-08-databases/07-transactions
go run .
`
