...
- Explain the engineering purpose of **Query Rows** in the context of databases.
...
**Query Rows** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-08-databases/04-query-rows
go run .
`
