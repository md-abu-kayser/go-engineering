...
- Explain the engineering purpose of **Optimistic Locking** in the context of databases.
...
**Optimistic Locking** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-08-databases/28-optimistic-locking
go run .
`
