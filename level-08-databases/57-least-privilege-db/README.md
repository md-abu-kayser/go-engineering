# 57 — Least Privilege Db

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Least Privilege Db** in the context of databases.
...
**Least Privilege Db** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-08-databases/57-least-privilege-db
go run .
`
