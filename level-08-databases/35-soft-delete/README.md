...
- Explain the engineering purpose of **Soft Delete** in the context of databases.
...
**Soft Delete** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-08-databases/35-soft-delete
go run .
`
