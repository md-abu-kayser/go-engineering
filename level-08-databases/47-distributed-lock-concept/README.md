# 47 — Distributed Lock Concept

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Distributed Lock Concept** in the context of databases.
...
**Distributed Lock Concept** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-08-databases/47-distributed-lock-concept
go run .
`
