# 17 — Sql Scanner Interface

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Sql Scanner Interface** in the context of databases.
...
**Sql Scanner Interface** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-08-databases/17-sql-scanner-interface
go run .
`
