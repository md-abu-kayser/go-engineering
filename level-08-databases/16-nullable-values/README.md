...
- Explain the engineering purpose of **Nullable Values** in the context of databases.
...
**Nullable Values** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-08-databases/16-nullable-values
go run .
`
