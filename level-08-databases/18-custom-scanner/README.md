...
- Explain the engineering purpose of **Custom Scanner** in the context of databases.
...
**Custom Scanner** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-08-databases/18-custom-scanner
go run .
`
