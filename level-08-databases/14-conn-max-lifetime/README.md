# 14 — Conn Max Lifetime

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Conn Max Lifetime** in the context of databases.
...
**Conn Max Lifetime** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-08-databases/14-conn-max-lifetime
go run .
`
