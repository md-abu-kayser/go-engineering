# 21 — Postgres Array Awareness

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Postgres Array Awareness** in the context of databases.
...
**Postgres Array Awareness** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-08-databases/21-postgres-array-awareness
go run .
`
