# 44 — Redis String Cache

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Redis String Cache** in the context of databases.
...
**Redis String Cache** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-08-databases/44-redis-string-cache
go run .
`
