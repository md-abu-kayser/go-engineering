# 37 — Batching Performance

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Batching Performance** in the context of performance.
...
**Batching Performance** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-14-performance/37-batching-performance
go run .
`
