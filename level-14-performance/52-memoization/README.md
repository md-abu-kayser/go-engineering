...
- Explain the engineering purpose of **Memoization** in the context of performance.
...
**Memoization** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-14-performance/52-memoization
go run .
`
