...
- Explain the engineering purpose of **Sharded Locks** in the context of performance.
...
**Sharded Locks** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-14-performance/43-sharded-locks
go run .
`
