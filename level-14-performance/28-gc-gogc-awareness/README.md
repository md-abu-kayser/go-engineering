# 28 — Gc Gogc Awareness

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Gc Gogc Awareness** in the context of performance.
...
**Gc Gogc Awareness** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-14-performance/28-gc-gogc-awareness
go run .
`
