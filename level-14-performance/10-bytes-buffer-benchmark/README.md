# 10 — Bytes Buffer Benchmark

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Bytes Buffer Benchmark** in the context of performance.
...
**Bytes Buffer Benchmark** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-14-performance/10-bytes-buffer-benchmark
go run .
`
