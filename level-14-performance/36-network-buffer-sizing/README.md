# 36 — Network Buffer Sizing

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Network Buffer Sizing** in the context of performance.
...
**Network Buffer Sizing** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-14-performance/36-network-buffer-sizing
go run .
`
