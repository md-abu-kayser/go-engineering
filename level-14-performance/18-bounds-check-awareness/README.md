# 18 — Bounds Check Awareness

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Bounds Check Awareness** in the context of performance.
...
**Bounds Check Awareness** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-14-performance/18-bounds-check-awareness
go run .
`
