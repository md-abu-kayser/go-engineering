# 17 — Inlining Awareness

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Inlining Awareness** in the context of performance.
...
**Inlining Awareness** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-14-performance/17-inlining-awareness
go run .
`
