...
- Explain the engineering purpose of **Slice Growth** in the context of performance.
...
**Slice Growth** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-14-performance/06-slice-growth
go run .
`
