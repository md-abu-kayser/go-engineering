...
- Explain the engineering purpose of **Stack Vs Heap** in the context of performance.
...
**Stack Vs Heap** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-14-performance/04-stack-vs-heap
go run .
`
