...
- Explain the engineering purpose of **Reflection Cost** in the context of performance.
...
**Reflection Cost** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-14-performance/14-reflection-cost
go run .
`
