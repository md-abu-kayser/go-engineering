# 34 — Zero Copy Awareness

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Zero Copy Awareness** in the context of performance.
...
**Zero Copy Awareness** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-14-performance/34-zero-copy-awareness
go run .
`
