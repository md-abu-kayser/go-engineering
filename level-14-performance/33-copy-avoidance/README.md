...
- Explain the engineering purpose of **Copy Avoidance** in the context of performance.
...
**Copy Avoidance** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-14-performance/33-copy-avoidance
go run .
`
