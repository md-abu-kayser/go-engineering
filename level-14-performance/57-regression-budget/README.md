# 57 — Regression Budget

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Regression Budget** in the context of performance.
...
**Regression Budget** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-14-performance/57-regression-budget
go run .
`
