# 58 — Profiling Workflow

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Profiling Workflow** in the context of performance.
...
**Profiling Workflow** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-14-performance/58-profiling-workflow
go run .
`
