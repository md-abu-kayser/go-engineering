# 31 — Sync Pool Benchmark

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Sync Pool Benchmark** in the context of performance.
...
**Sync Pool Benchmark** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-14-performance/31-sync-pool-benchmark
go run .
`
