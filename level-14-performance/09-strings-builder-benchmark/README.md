# 9 — Strings Builder Benchmark

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Strings Builder Benchmark** in the context of performance.
...
**Strings Builder Benchmark** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-14-performance/09-strings-builder-benchmark
go run .
`
