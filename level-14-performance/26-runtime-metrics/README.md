...
- Explain the engineering purpose of **Runtime Metrics** in the context of performance.
...
**Runtime Metrics** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-14-performance/26-runtime-metrics
go run .
`
