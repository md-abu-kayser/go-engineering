...
- Explain the engineering purpose of **Gc Percent** in the context of performance.
...
**Gc Percent** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-14-performance/27-gc-percent
go run .
`
