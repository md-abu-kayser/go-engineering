...
- Explain the engineering purpose of **Compiler Escape Analysis** in the context of performance.
...
**Compiler Escape Analysis** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-14-performance/03-compiler-escape-analysis
go run .
`
