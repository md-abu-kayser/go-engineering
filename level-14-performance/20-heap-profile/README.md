...
- Explain the engineering purpose of **Heap Profile** in the context of performance.
...
**Heap Profile** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-14-performance/20-heap-profile
go run .
`
