...
- Explain the engineering purpose of **Io Throughput** in the context of performance.
...
**Io Throughput** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-14-performance/35-io-throughput
go run .
`
