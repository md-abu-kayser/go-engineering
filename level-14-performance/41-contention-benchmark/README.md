# 41 — Contention Benchmark

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Contention Benchmark** in the context of performance.
...
**Contention Benchmark** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-14-performance/41-contention-benchmark
go run .
`
