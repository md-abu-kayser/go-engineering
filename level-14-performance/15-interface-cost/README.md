...
- Explain the engineering purpose of **Interface Cost** in the context of performance.
...
**Interface Cost** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-14-performance/15-interface-cost
go run .
`
