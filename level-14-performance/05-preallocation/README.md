...
- Explain the engineering purpose of **Preallocation** in the context of performance.
...
**Preallocation** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-14-performance/05-preallocation
go run .
`
