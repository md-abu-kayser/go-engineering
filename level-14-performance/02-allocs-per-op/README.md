...
- Explain the engineering purpose of **Allocs Per Op** in the context of performance.
...
**Allocs Per Op** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-14-performance/02-allocs-per-op
go run .
`
