# 49 — Api Compatibility Test

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Api Compatibility Test** in the context of testing quality.
...
**Api Compatibility Test** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-09-testing-quality/49-api-compatibility-test
go run .
`
