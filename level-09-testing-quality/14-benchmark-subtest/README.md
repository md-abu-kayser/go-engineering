# 14 — Benchmark Subtest

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Benchmark Subtest** in the context of testing quality.
...
**Benchmark Subtest** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-09-testing-quality/14-benchmark-subtest
go run .
`
