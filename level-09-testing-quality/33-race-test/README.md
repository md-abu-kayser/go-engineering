...
- Explain the engineering purpose of **Race Test** in the context of testing quality.
...
**Race Test** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-09-testing-quality/33-race-test
go run .
`
