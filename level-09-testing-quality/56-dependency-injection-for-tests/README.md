# 56 — Dependency Injection For Tests

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Dependency Injection For Tests** in the context of testing quality.
...
**Dependency Injection For Tests** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-09-testing-quality/56-dependency-injection-for-tests
go run .
`
