...
- Explain the engineering purpose of **Benchmark Allocs** in the context of testing quality.
...
**Benchmark Allocs** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-09-testing-quality/12-benchmark-allocs
go run .
`
