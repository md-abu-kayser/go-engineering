# 39 — Deterministic Tests

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Deterministic Tests** in the context of testing quality.
...
**Deterministic Tests** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-09-testing-quality/39-deterministic-tests
go run .
`
