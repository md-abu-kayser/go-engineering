...
- Explain the engineering purpose of **Testdata Directory** in the context of testing quality.
...
**Testdata Directory** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-09-testing-quality/06-testdata-directory
go run .
`
