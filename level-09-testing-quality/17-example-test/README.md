...
- Explain the engineering purpose of **Example Test** in the context of testing quality.
...
**Example Test** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-09-testing-quality/17-example-test
go run .
`
