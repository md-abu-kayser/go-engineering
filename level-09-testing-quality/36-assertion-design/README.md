...
- Explain the engineering purpose of **Assertion Design** in the context of testing quality.
...
**Assertion Design** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-09-testing-quality/36-assertion-design
go run .
`
