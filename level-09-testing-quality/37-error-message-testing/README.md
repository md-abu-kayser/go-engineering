# 37 — Error Message Testing

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Error Message Testing** in the context of testing quality.
...
**Error Message Testing** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-09-testing-quality/37-error-message-testing
go run .
`
