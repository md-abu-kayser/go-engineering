# 32 — Repository Integration Test

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Repository Integration Test** in the context of testing quality.
...
**Repository Integration Test** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-09-testing-quality/32-repository-integration-test
go run .
`
