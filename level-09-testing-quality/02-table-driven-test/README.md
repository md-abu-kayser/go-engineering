...
- Explain the engineering purpose of **Table Driven Test** in the context of testing quality.
...
**Table Driven Test** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-09-testing-quality/02-table-driven-test
go run .
`
