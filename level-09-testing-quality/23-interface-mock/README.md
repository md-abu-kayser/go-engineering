...
- Explain the engineering purpose of **Interface Mock** in the context of testing quality.
...
**Interface Mock** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-09-testing-quality/23-interface-mock
go run .
`
