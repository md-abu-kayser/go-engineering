# 48 — Performance Regression Test

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Performance Regression Test** in the context of testing quality.
...
**Performance Regression Test** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-09-testing-quality/48-performance-regression-test
go run .
`
