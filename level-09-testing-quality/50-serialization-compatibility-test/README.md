# 50 — Serialization Compatibility Test

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Serialization Compatibility Test** in the context of testing quality.
...
**Serialization Compatibility Test** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-09-testing-quality/50-serialization-compatibility-test
go run .
`
