...
- Explain the engineering purpose of **Benchmark Basic** in the context of testing quality.
...
**Benchmark Basic** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-09-testing-quality/11-benchmark-basic
go run .
`
