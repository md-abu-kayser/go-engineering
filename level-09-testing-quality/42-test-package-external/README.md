# 42 — Test Package External

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Test Package External** in the context of testing quality.
...
**Test Package External** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-09-testing-quality/42-test-package-external
go run .
`
