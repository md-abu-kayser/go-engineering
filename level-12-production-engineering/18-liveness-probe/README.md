...
- Explain the engineering purpose of **Liveness Probe** in the context of production engineering.
...
**Liveness Probe** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-12-production-engineering/18-liveness-probe
go run .
`
