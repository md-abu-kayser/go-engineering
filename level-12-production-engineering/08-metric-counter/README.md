...
- Explain the engineering purpose of **Metric Counter** in the context of production engineering.
...
**Metric Counter** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-12-production-engineering/08-metric-counter
go run .
`
