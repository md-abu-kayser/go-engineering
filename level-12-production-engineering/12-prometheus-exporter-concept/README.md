# 12 — Prometheus Exporter Concept

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Prometheus Exporter Concept** in the context of production engineering.
...
**Prometheus Exporter Concept** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-12-production-engineering/12-prometheus-exporter-concept
go run .
`
