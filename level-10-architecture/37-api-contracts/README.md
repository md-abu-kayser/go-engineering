...
- Explain the engineering purpose of **Api Contracts** in the context of architecture.
...
**Api Contracts** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-10-architecture/37-api-contracts
go run .
`
