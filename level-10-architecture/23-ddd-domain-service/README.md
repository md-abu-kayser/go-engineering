# 23 — Ddd Domain Service

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Ddd Domain Service** in the context of architecture.
...
**Ddd Domain Service** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-10-architecture/23-ddd-domain-service
go run .
`
