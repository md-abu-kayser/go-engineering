...
- Explain the engineering purpose of **Layered Architecture** in the context of architecture.
...
**Layered Architecture** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-10-architecture/01-layered-architecture
go run .
`
