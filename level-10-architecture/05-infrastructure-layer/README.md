...
- Explain the engineering purpose of **Infrastructure Layer** in the context of architecture.
...
**Infrastructure Layer** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-10-architecture/05-infrastructure-layer
go run .
`
