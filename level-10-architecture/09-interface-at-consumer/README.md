# 9 — Interface At Consumer

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Interface At Consumer** in the context of architecture.
...
**Interface At Consumer** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-10-architecture/09-interface-at-consumer
go run .
`
