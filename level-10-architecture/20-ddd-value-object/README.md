...
- Explain the engineering purpose of **Ddd Value Object** in the context of architecture.
...
**Ddd Value Object** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-10-architecture/20-ddd-value-object
go run .
`
