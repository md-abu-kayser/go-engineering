...
- Explain the engineering purpose of **Error Taxonomy** in the context of architecture.
...
**Error Taxonomy** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-10-architecture/41-error-taxonomy
go run .
`
