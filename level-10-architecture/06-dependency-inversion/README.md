...
- Explain the engineering purpose of **Dependency Inversion** in the context of architecture.
...
**Dependency Inversion** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-10-architecture/06-dependency-inversion
go run .
`
