# 15 — Adapter Messagebus

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Adapter Messagebus** in the context of architecture.
...
**Adapter Messagebus** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-10-architecture/15-adapter-messagebus
go run .
`
