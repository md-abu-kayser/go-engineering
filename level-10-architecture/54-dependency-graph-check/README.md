# 54 — Dependency Graph Check

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Dependency Graph Check** in the context of architecture.
...
**Dependency Graph Check** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-10-architecture/54-dependency-graph-check
go run .
`
