...
- Explain the engineering purpose of **Adapter Sql** in the context of architecture.
...
**Adapter Sql** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-10-architecture/13-adapter-sql
go run .
`
