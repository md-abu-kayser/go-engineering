...
- Explain the engineering purpose of **Hexagonal Core** in the context of architecture.
...
**Hexagonal Core** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-10-architecture/11-hexagonal-core
go run .
`
