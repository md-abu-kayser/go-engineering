...
- Explain the engineering purpose of **Dependency Rules** in the context of architecture.
...
**Dependency Rules** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-10-architecture/35-dependency-rules
go run .
`
