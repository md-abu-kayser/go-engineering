...
- Explain the engineering purpose of **Cqrs Light** in the context of architecture.
...
**Cqrs Light** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-10-architecture/28-cqrs-light
go run .
`
