...
- Explain the engineering purpose of **Pipeline Pattern** in the context of design patterns.
...
**Pipeline Pattern** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/30-pipeline-pattern
go run .
`
