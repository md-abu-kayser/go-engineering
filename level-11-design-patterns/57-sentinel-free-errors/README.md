# 57 — Sentinel Free Errors

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Sentinel Free Errors** in the context of design patterns.
...
**Sentinel Free Errors** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/57-sentinel-free-errors
go run .
`
