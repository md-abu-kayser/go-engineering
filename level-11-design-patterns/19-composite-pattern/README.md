...
- Explain the engineering purpose of **Composite Pattern** in the context of design patterns.
...
**Composite Pattern** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/19-composite-pattern
go run .
`
