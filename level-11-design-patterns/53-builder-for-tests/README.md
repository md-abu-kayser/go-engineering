# 53 — Builder For Tests

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Builder For Tests** in the context of design patterns.
...
**Builder For Tests** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/53-builder-for-tests
go run .
`
