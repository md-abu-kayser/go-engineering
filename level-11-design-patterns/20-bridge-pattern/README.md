...
- Explain the engineering purpose of **Bridge Pattern** in the context of design patterns.
...
**Bridge Pattern** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/20-bridge-pattern
go run .
`
