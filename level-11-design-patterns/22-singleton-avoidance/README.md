# 22 — Singleton Avoidance

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Singleton Avoidance** in the context of design patterns.
...
**Singleton Avoidance** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/22-singleton-avoidance
go run .
`
