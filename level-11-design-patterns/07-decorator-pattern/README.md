...
- Explain the engineering purpose of **Decorator Pattern** in the context of design patterns.
...
**Decorator Pattern** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/07-decorator-pattern
go run .
`
