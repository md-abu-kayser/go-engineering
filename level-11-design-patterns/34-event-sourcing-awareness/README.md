# 34 — Event Sourcing Awareness

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Event Sourcing Awareness** in the context of design patterns.
...
**Event Sourcing Awareness** is most useful when it makes a program's behavior clearer, safer, or easier to change.
This lesson deliberately keeps the example local and observable: it demonstrates a policy interface and a concrete strategy selected by the caller. The
...
`ash
cd level-11-design-patterns/34-event-sourcing-awareness
go run .
`
