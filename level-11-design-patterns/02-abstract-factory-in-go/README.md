# 2 — Abstract Factory In Go

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Abstract Factory In Go** in the context of design patterns.
...
**Abstract Factory In Go** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/02-abstract-factory-in-go
go run .
`
