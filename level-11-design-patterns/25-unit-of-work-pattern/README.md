# 25 — Unit Of Work Pattern

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Unit Of Work Pattern** in the context of design patterns.
...
**Unit Of Work Pattern** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/25-unit-of-work-pattern
go run .
`
