...
- Explain the engineering purpose of **Iterator Pattern** in the context of design patterns.
...
**Iterator Pattern** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/18-iterator-pattern
go run .
`
