# 49 — Idempotency Pattern

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Idempotency Pattern** in the context of design patterns.
...
**Idempotency Pattern** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/49-idempotency-pattern
go run .
`
