# 55 — Functional Options

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Functional Options** in the context of design patterns.
...
**Functional Options** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/55-functional-options
go run .
`
