...
- Explain the engineering purpose of **Visitor Pattern** in the context of design patterns.
...
**Visitor Pattern** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/17-visitor-pattern
go run .
`
