...
- Explain the engineering purpose of **Outbox Pattern** in the context of design patterns.
...
**Outbox Pattern** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/36-outbox-pattern
go run .
`
