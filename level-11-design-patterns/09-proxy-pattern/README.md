...
- Explain the engineering purpose of **Proxy Pattern** in the context of design patterns.
...
**Proxy Pattern** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/09-proxy-pattern
go run .
`
