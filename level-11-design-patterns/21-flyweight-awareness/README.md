# 21 — Flyweight Awareness

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Flyweight Awareness** in the context of design patterns.
...
**Flyweight Awareness** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/21-flyweight-awareness
go run .
`
