# 16 — Template Method In Go

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Template Method In Go** in the context of design patterns.
...
**Template Method In Go** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/16-template-method-in-go
go run .
`
