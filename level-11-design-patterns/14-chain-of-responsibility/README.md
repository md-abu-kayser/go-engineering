...
- Explain the engineering purpose of **Chain Of Responsibility** in the context of design patterns.
...
**Chain Of Responsibility** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/14-chain-of-responsibility
go run .
`
