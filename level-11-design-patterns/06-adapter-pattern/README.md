...
- Explain the engineering purpose of **Adapter Pattern** in the context of design patterns.
...
**Adapter Pattern** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/06-adapter-pattern
go run .
`
