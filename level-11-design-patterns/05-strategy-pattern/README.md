...
- Explain the engineering purpose of **Strategy Pattern** in the context of design patterns.
...
**Strategy Pattern** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/05-strategy-pattern
go run .
`
