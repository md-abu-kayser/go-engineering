...
- Explain the engineering purpose of **Command Bus** in the context of design patterns.
...
**Command Bus** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/11-command-bus
go run .
`
