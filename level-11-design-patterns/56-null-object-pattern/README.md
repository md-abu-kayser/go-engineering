...
- Explain the engineering purpose of **Null Object Pattern** in the context of design patterns.
...
**Null Object Pattern** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/56-null-object-pattern
go run .
`
