...
- Explain the engineering purpose of **Repository Pattern** in the context of design patterns.
...
**Repository Pattern** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/24-repository-pattern
go run .
`
