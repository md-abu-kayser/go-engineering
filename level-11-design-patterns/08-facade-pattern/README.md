...
- Explain the engineering purpose of **Facade Pattern** in the context of design patterns.
...
**Facade Pattern** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/08-facade-pattern
go run .
`
