...
- Explain the engineering purpose of **Builder Pattern** in the context of design patterns.
...
**Builder Pattern** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/03-builder-pattern
go run .
`
