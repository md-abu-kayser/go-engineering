...
- Explain the engineering purpose of **Functional Builder** in the context of design patterns.
...
**Functional Builder** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/04-functional-builder
go run .
`
