...
- Explain the engineering purpose of **Pub Sub Pattern** in the context of design patterns.
...
**Pub Sub Pattern** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/13-pub-sub-pattern
go run .
`
