# 32 — Fan Out Fan In Pattern

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Fan Out Fan In Pattern** in the context of design patterns.
...
**Fan Out Fan In Pattern** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/32-fan-out-fan-in-pattern
go run .
`
