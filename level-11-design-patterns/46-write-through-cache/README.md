# 46 — Write Through Cache

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Write Through Cache** in the context of design patterns.
...
**Write Through Cache** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/46-write-through-cache
go run .
`
