...
- Explain the engineering purpose of **State Pattern** in the context of design patterns.
...
**State Pattern** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/15-state-pattern
go run .
`
