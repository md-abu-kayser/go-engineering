...
- Explain the engineering purpose of **Factory Pattern** in the context of design patterns.
...
**Factory Pattern** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/01-factory-pattern
go run .
`
