...
- Explain the engineering purpose of **Saga Pattern** in the context of design patterns.
...
**Saga Pattern** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-11-design-patterns/35-saga-pattern
go run .
`
