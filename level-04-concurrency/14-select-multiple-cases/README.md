# 14 — Select Multiple Cases

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Select Multiple Cases** in the context of concurrency.
...
**Select Multiple Cases** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-04-concurrency/14-select-multiple-cases
go run .
`
