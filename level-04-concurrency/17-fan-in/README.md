...
- Explain the engineering purpose of **Fan In** in the context of concurrency.
...
**Fan In** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-04-concurrency/17-fan-in
go run .
`
