...
- Explain the engineering purpose of **Goroutine Leaks** in the context of concurrency.
...
**Goroutine Leaks** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-04-concurrency/03-goroutine-leaks
go run .
`
