# 16 — Directional Channels

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Directional Channels** in the context of concurrency.
...
**Directional Channels** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-04-concurrency/16-directional-channels
go run .
`
