...
- Explain the engineering purpose of **Once** in the context of concurrency.
...
**Once** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-04-concurrency/31-once
go run .
`
