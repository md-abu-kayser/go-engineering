...
- Explain the engineering purpose of **Buffered Channels** in the context of concurrency.
...
**Buffered Channels** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-04-concurrency/06-buffered-channels
go run .
`
