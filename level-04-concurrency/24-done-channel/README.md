...
- Explain the engineering purpose of **Done Channel** in the context of concurrency.
...
**Done Channel** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-04-concurrency/24-done-channel
go run .
`
