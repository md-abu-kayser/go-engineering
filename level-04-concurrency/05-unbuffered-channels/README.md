...
- Explain the engineering purpose of **Unbuffered Channels** in the context of concurrency.
...
**Unbuffered Channels** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-04-concurrency/05-unbuffered-channels
go run .
`
