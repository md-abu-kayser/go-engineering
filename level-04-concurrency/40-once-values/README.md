...
- Explain the engineering purpose of **Once Values** in the context of concurrency.
...
**Once Values** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-04-concurrency/40-once-values
go run .
`
