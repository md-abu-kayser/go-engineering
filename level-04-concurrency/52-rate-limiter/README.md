...
- Explain the engineering purpose of **Rate Limiter** in the context of concurrency.
...
**Rate Limiter** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-04-concurrency/52-rate-limiter
go run .
`
