# 25 — Context Cancellation

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Context Cancellation** in the context of concurrency.
...
**Context Cancellation** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-04-concurrency/25-context-cancellation
go run .
`
