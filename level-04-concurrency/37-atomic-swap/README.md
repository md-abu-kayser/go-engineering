...
- Explain the engineering purpose of **Atomic Swap** in the context of concurrency.
...
**Atomic Swap** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-04-concurrency/37-atomic-swap
go run .
`
