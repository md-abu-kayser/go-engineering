# 36 — Atomic Load Store

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Atomic Load Store** in the context of concurrency.
...
**Atomic Load Store** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-04-concurrency/36-atomic-load-store
go run .
`
