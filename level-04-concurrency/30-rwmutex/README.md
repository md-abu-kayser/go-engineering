...
- Explain the engineering purpose of **Rwmutex** in the context of concurrency.
...
**Rwmutex** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-04-concurrency/30-rwmutex
go run .
`
