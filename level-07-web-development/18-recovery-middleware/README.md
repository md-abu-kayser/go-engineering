# 18 — Recovery Middleware

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Recovery Middleware** in the context of web development.
...
**Recovery Middleware** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-07-web-development/18-recovery-middleware
go run .
`
