# 34 — Html Template Server

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Html Template Server** in the context of web development.
...
**Html Template Server** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-07-web-development/34-html-template-server
go run .
`
