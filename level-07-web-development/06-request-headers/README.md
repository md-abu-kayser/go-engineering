...
- Explain the engineering purpose of **Request Headers** in the context of web development.
...
**Request Headers** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-07-web-development/06-request-headers
go run .
`
