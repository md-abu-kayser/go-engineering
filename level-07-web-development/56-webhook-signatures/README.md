# 56 — Webhook Signatures

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Webhook Signatures** in the context of web development.
...
**Webhook Signatures** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-07-web-development/56-webhook-signatures
go run .
`
