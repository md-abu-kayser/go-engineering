# 36 — Template Escaping

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Template Escaping** in the context of web development.
...
**Template Escaping** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-07-web-development/36-template-escaping
go run .
`
