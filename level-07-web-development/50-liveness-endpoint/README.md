# 50 — Liveness Endpoint

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Liveness Endpoint** in the context of web development.
...
**Liveness Endpoint** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-07-web-development/50-liveness-endpoint
go run .
`
