# 37 — Validation Basics

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Validation Basics** in the context of web development.
...
**Validation Basics** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-07-web-development/37-validation-basics
go run .
`
