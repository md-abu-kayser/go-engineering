...
- Explain the engineering purpose of **Json Request** in the context of web development.
...
**Json Request** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-07-web-development/11-json-request
go run .
`
