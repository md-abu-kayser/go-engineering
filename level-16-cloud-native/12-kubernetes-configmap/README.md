...
- Explain the engineering purpose of **Kubernetes Configmap** in the context of cloud native.
...
**Kubernetes Configmap** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-16-cloud-native/12-kubernetes-configmap
go run .
`
