# 27 — Config Reload Awareness

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Config Reload Awareness** in the context of cloud native.
...
**Config Reload Awareness** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-16-cloud-native/27-config-reload-awareness
go run .
`
