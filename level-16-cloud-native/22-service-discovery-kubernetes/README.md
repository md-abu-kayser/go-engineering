# 22 — Service Discovery Kubernetes

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Service Discovery Kubernetes** in the context of cloud native.
...
**Service Discovery Kubernetes** is most useful when it makes a program's behavior clearer, safer, or easier to change.
This lesson deliberately keeps the example local and observable: it demonstrates deployment configuration separated from readiness behavior. The
...
`ash
cd level-16-cloud-native/22-service-discovery-kubernetes
go run .
`
