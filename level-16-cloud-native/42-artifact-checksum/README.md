# 42 — Artifact Checksum

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Artifact Checksum** in the context of cloud native.
...
**Artifact Checksum** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-16-cloud-native/42-artifact-checksum
go run .
`
