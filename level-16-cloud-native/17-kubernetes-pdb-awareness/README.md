# 17 — Kubernetes Pdb Awareness

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Kubernetes Pdb Awareness** in the context of cloud native.
...
**Kubernetes Pdb Awareness** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-16-cloud-native/17-kubernetes-pdb-awareness
go run .
`
