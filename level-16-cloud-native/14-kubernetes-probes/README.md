# 14 — Kubernetes Probes

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Kubernetes Probes** in the context of cloud native.
...
**Kubernetes Probes** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-16-cloud-native/14-kubernetes-probes
go run .
`
