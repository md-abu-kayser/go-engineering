# 34 — Image Digest Pinning

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Image Digest Pinning** in the context of cloud native.
...
**Image Digest Pinning** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-16-cloud-native/34-image-digest-pinning
go run .
`
