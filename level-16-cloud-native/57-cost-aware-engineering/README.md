# 57 — Cost Aware Engineering

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Cost Aware Engineering** in the context of cloud native.
...
**Cost Aware Engineering** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-16-cloud-native/57-cost-aware-engineering
go run .
`
