# 46 — Object Storage Upload

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Object Storage Upload** in the context of cloud native.
...
**Object Storage Upload** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-16-cloud-native/46-object-storage-upload
go run .
`
