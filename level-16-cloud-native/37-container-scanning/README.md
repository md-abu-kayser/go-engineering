# 37 — Container Scanning

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Container Scanning** in the context of cloud native.
...
**Container Scanning** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-16-cloud-native/37-container-scanning
go run .
`
