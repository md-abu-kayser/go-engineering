# 16 — Kubernetes Hpa Awareness

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Kubernetes Hpa Awareness** in the context of cloud native.
...
**Kubernetes Hpa Awareness** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-16-cloud-native/16-kubernetes-hpa-awareness
go run .
`
