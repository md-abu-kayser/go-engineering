# 35 — Supply Chain Basics

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Supply Chain Basics** in the context of cloud native.
...
**Supply Chain Basics** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-16-cloud-native/35-supply-chain-basics
go run .
`
