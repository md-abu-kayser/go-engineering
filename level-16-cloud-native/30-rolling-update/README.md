...
- Explain the engineering purpose of **Rolling Update** in the context of cloud native.
...
**Rolling Update** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-16-cloud-native/30-rolling-update
go run .
`
