...
- Explain the engineering purpose of **Kubernetes Ingress** in the context of cloud native.
...
**Kubernetes Ingress** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-16-cloud-native/18-kubernetes-ingress
go run .
`
