...
- Explain the engineering purpose of **Container Healthcheck** in the context of cloud native.
...
**Container Healthcheck** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-16-cloud-native/06-container-healthcheck
go run .
`
