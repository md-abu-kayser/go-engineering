# 19 — Service Account Awareness

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Service Account Awareness** in the context of cloud native.
...
**Service Account Awareness** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-16-cloud-native/19-service-account-awareness
go run .
`
