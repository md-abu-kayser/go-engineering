# 54 — Multi Region Awareness

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Multi Region Awareness** in the context of cloud native.
...
**Multi Region Awareness** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-16-cloud-native/54-multi-region-awareness
go run .
`
