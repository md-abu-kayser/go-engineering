# 5 — Distroless Awareness

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Distroless Awareness** in the context of cloud native.
...
**Distroless Awareness** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-16-cloud-native/05-distroless-awareness
go run .
`
