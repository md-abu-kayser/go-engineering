# 23 — Sidecar Awareness

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Sidecar Awareness** in the context of cloud native.
...
**Sidecar Awareness** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-16-cloud-native/23-sidecar-awareness
go run .
`
