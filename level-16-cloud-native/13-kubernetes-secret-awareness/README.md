# 13 — Kubernetes Secret Awareness

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Kubernetes Secret Awareness** in the context of cloud native.
...
**Kubernetes Secret Awareness** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-16-cloud-native/13-kubernetes-secret-awareness
go run .
`
