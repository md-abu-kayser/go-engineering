...
- Explain the engineering purpose of **Docker Compose Local** in the context of cloud native.
...
**Docker Compose Local** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-16-cloud-native/09-docker-compose-local
go run .
`
