...
- Explain the engineering purpose of **Kubernetes Resources** in the context of cloud native.
...
**Kubernetes Resources** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-16-cloud-native/15-kubernetes-resources
go run .
`
