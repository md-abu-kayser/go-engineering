# 55 — Zone Failure Awareness

## 🎯 Learning Objectives

By the end of this lesson you will be able to:

- Explain the engineering purpose of **Zone Failure Awareness** in the context of cloud native.
...
**Zone Failure Awareness** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-16-cloud-native/55-zone-failure-awareness
go run .
`
