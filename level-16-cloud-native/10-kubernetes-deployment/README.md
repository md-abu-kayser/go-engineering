...
- Explain the engineering purpose of **Kubernetes Deployment** in the context of cloud native.
...
**Kubernetes Deployment** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-16-cloud-native/10-kubernetes-deployment
go run .
`
