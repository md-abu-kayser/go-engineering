...
- Explain the engineering purpose of **Ci Security Scan** in the context of cloud native.
...
**Ci Security Scan** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-16-cloud-native/40-ci-security-scan
go run .
`
