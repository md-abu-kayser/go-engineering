...
- Explain the engineering purpose of **Dockerfile Basics** in the context of cloud native.
...
**Dockerfile Basics** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-16-cloud-native/03-dockerfile-basics
go run .
`
