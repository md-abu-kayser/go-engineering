...
- Explain the engineering purpose of **Sbom Awareness** in the context of cloud native.
...
**Sbom Awareness** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-16-cloud-native/36-sbom-awareness
go run .
`
