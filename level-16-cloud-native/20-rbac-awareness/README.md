...
- Explain the engineering purpose of **Rbac Awareness** in the context of cloud native.
...
**Rbac Awareness** is most useful when it makes a program's behavior clearer, safer, or easier to change.
...
`ash
cd level-16-cloud-native/20-rbac-awareness
go run .
`
